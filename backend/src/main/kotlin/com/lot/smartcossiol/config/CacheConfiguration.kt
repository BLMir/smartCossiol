...
class CacheConfiguration(jHipsterProperties: JHipsterProperties) {
    ...
    fun cacheManagerCustomizer(): JCacheManagerCustomizer {
        return JCacheManagerCustomizer { cm ->
            createCache(cm, com.lot.smartcossiol.repository.UserRepository.USERS_BY_LOGIN_CACHE)
            createCache(cm, com.lot.smartcossiol.repository.UserRepository.USERS_BY_EMAIL_CACHE)
